...
def test_type_of_get_part_of_speech_is_list_or_str():
    ...
    assert (type(w) == list or type(w) == str) and (
        isinstance(w, list) or isinstance(w, str)
    )
    ...
    [
        (
            "cowboy",
            {
                "NOUN": [
                    {
                        "meaning": "a man who herds and tends cattle on a ranch, especially in the western US, and who traditionally goes about most of his work on horseback",
                        "examples": None,
                    },
                    {
                        "meaning": "a man who exhibits the skills attributed to such cowboys, especially in rodeos",
                        "examples": None,
                    },
                    {"meaning": "Chiefly Northeastern US", "examples": None},
                ]
            },
        ),
        (
                ...
                "ADJECTIVE": [
                    {
                        ...
                        "examples": " a delicate lace collar",
                    },
                    {
                        "meaning": "easily broken or damaged; physically weak; fragile; frail",
                        "examples": " delicate porcelain;a delicate child",
                    },
                    {
                        "meaning": "so fine as to be scarcely perceptible; subtle",
                        "examples": " a delicate flavor",
                    },
                ]
            },
        ),
    ...
    [
        (
            "grand",
            {
                "ADJECTIVE": [
                    {
                        "meaning": "used of a person's appearance or behavior",
                        "examples": None,
                    },
                    {
                        "meaning": "the most important and magnificent in adornment",
                        "examples": None,
                    },
                    {
                        "meaning": "of behavior that is impressive and ambitious in scale or scope",
                        "examples": None,
                    },
                    {
                        "meaning": "large and impressive in physical size or extent",
                        "examples": None,
                    },
                    {
                    ...
                    {"meaning": "of or befitting a lord", "examples": None},
                    {"meaning": "extraordinarily good or great", "examples": None},
                    {"meaning": "rich and superior in quality", "examples": None},
                ],
                "NOUN": [
                    {
                        "meaning": "a piano with the strings on a horizontal harp-shaped frame",
                        "examples": None,
                    },
                    {
        ...
        (
            ...
            {
                "NOUN": [
                    {"meaning": "self-propelled movement", "examples": None},
                    {
                        "meaning": "the act of going from one place to another",
                        "examples": None,
                    },
                    {
                        "meaning": "a movement through space that changes the location of something",
                        "examples": None,
                    },
                ],
                "VERB": [
                    {"meaning": "change location", "examples": None},
                    {
                        "meaning": "undergo transportation as in a vehicle",
                        "examples": None,
                    },
                    {"meaning": "make a trip for pleasure", "examples": None},
                    {"meaning": "undertake a journey or trip", "examples": None},
                    {"meaning": "travel upon or across", "examples": None},
                    {
                        "meaning": "travel from place to place, as for the purpose of finding work, preaching, or acting as a judge",
                        "examples": None,
                    },
                ],
            },
